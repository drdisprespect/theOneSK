...
class AzureFoundryOrchestration:
    ...
    async def create_transaction_analysis_agent(self):
        ...
        try:
            ...
            print(f"✅ Transaction Agent created with name: {self.transaction_agent_name}")
            ...
            print("✅ Transaction Agent created with direct Azure Foundry integration")
...
class AIGroupChatManager(GroupChatManager):
    ...
    async def filter_results(self, chat_history: ChatHistory) -> MessageResult:
        ...
        if self._is_raw_output(content):
            print("🔍 Detected raw output - performing analysis...")
            try:
...
def agent_response_callback(message: ChatMessageContent) -> None:
    """Callback to display agent responses with enhanced formatting"""
    agent_name = message.name or "Agent"
    content = message.content or ""
    
    # Add visual distinction for different agents
...
async def interactive_foundry_orchestration():
    ...
    print("Intelligent agent routing with specialized Azure Foundry capabilities including transaction analysis and Career advice\n")
    ...
    try:
        ...
        while True:
            try:
                ...
                print("📡 Orchestrating agent response...\n")
